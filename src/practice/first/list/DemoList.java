...
public class DemoList {
    public static void main(String[] args) {
        ...
        System.out.println("Кинотеатр (с естественным порядком сортировки)");
        ...
        if (film == null) System.out.println("В кинотеатре нет фильма с id 7");
        else System.out.println(film);
        //Проверяем есть ли в первом кинотеатре фильм с id 3
        film = cinema1.getFilmById(3);
        if (film == null) System.out.println("В кинотеатре нет фильма с id 3");
        else System.out.println(film);
